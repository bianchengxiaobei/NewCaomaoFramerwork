...
namespace CaomaoFramework
{
    ...
    public struct TSQuaternion
    {
        ...
        public static TSQuaternion LookRotation(FPVector3 forward)
        {
        ...
        public static TSQuaternion CreateFromMatrix(FPMatrix matrix)
        {
            TSQuaternion result;
        ...
        public static void CreateFromMatrix(ref FPMatrix matrix, out TSQuaternion result)
        {
        ...
        /**
         *  @brief Rotates a {@link FPVector3} by the {@link TSQuanternion}.
         **/
        public static FPVector3 operator *(TSQuaternion quat, FPVector3 vec)
        {
            FP num = quat.x * 2f;
            FP num2 = quat.y * 2f;
            FP num3 = quat.z * 2f;
