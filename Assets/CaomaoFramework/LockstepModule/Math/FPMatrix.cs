...
namespace CaomaoFramework
{
    ...
    public struct FPMatrix
    {
        ...
        public static FPMatrix CreateFromQuaternion(TSQuaternion quaternion)
        {
            FPMatrix result;
        ...
        public static void CreateFromQuaternion(ref TSQuaternion quaternion, out FPMatrix result)
        {
